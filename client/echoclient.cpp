...
int main(int argc, char **argv) 
{
    ...
    //{
	    ...
	    Mat img = imread("rx_gray_image.png", cv::IMREAD_UNCHANGED);

	    //namedWindow("rx_gray_image.png", cv::WINDOW_AUTOSIZE);
	    //imshow( "rx_gray_image.png", img );
	    Mat img1 = imread("rx_gray_image.png", cv::IMREAD_UNCHANGED);
	    //namedWindow("rx_gray_image.png", cv::WINDOW_AUTOSIZE);
